---
title: "05_HDCA_heart_stereoscope_results"
...
#### Plot cells from a cluster on a slide

```{r fig.asp=0.7}
# MapFeatures(ST, 
#             features = "4-35", #single-cell cluster to plot
#             section_number = 27, #ST section to plot on
#             image_use = "raw", 
#             colors = c("lightgrey","mistyrose", "red", "darkred", "black"),
#             add_scalebar = TRUE, 
#             scalebar_gg = scalebar(x = 1000), 
#             scalebar_position = c(0.6, 0.9), 
#             scalebar_height = 0.07) & ThemeLegendRight()
```
...
#### Plot multiple clusters on 1 slide (delete later)

This in mainly (if not only) to visualize where multiple single-cell clusters are projected on a single section

```{r}
# MapMultipleFeatures(ST, 
#                     features = c("8", "13", "17", "4-35"), #clusters to plot. When overlap, highest intensities take over
#                     section_number = 10, 
#                     scale = "free" #new scale for each feature
#                     )
```
...
```{r fig.asp=0.7}
# MapFeatures(ST, 
#             features = "CM-1", #single-cell cluster to plot
#             section_number = 27, #ST section to plot on
#             image_use = "raw", 
#             colors = c("lightgrey","mistyrose", "red", "darkred", "black"),
#             add_scalebar = TRUE, 
