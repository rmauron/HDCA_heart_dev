...
#### Heatmap of niches (Fig. 7B, 7D, Extended Fig. 7C)
...
#### Niche 1 "CM-18","CM-4-2", "CM-4-1", "EN-1", "EN-12" (Extended Fig. 7B)
...
#### Niche 2 "EN-19", "EN-15", "EN-13", "EN-10", "EN-2" (Extended Fig. 7D)
...
#### ST deep level all ages (Extended Fig. 7A)
...
#### "CM-4-2", "CM-4-1" - 4 different sections (Extended Fig. 3C)
...
#### "CM-8-2", "CM-18", "CM-19-1", in sc. 3 (Extended Fig. 3E)
...
####  "IN-13", "CM-14", "IN-1"  in sc. 22 (Extended Fig. 4B)
...
#### "IN-13",  "FB-1",  "IN-1"   in sc. 32 and 34 (Extended Fig. 4B)
...
#### "IN-8", "IN-19", sc. 16 (Extended Fig. 4C)
...
#### "EN-7", "EN-17", sc. 6 (Extended Fig. 5D)
...
#### "EN-6", "EN-18", "EN-16", sc. 18 (Extended Fig. 5E)
...
#### "FB-7", "FB-8", "FB-14", sc. 23 (Extended Fig. 6E)
...
#### "FB-4", "FB-11", "FB-13", sc.22 (Supp Fig. 6F)
...
#### "FB-6", "HL-10", "EN-15", sc. 20 (Extended Fig. 7C)
...
#### "FB-1", "HL-15", "EN-20", sc. 20 (Extended Fig. 7C)
...
#### "FB-1", "HL-8", "EN-19", sc.20 (Extended Fig. 7C)
...
#### "CM-6", "CM-1", sc. 5, 2, 11, 24

```{r}
plots <- CellColoc(ST,
                      features = c("CM-6", "CM-1"),
                      section_number = 5)

pdf(file = paste0(myfolder, "colocalization/CM-6_CM-1_section_5.pdf"), width = 15.75, height = 4.5)
plots
dev.off()
```
...
pdf(file = paste0(myfolder, "colocalization/CM-6_CM-1_section_2.pdf"), width = 15.75, height = 4.5)
plots
dev.off()
```
...
pdf(file = paste0(myfolder, "colocalization/CM-6_CM-1_section_11.pdf"), width = 15.75, height = 4.5)
plots
dev.off()
```
...
pdf(file = paste0(myfolder, "colocalization/CM-6_CM-1_section_24.pdf"), width = 15.75, height = 4.5)
plots
dev.off()
```


#### "EN-7", "EN-17", sc. 29, 15 (Supp. Fig. 11D)
...
pdf(file = paste0(myfolder, "colocalization/EN-7_EN-17_section_29.pdf"), width = 15.75, height = 4.5)
plots
dev.off()
```
...
pdf(file = paste0(myfolder, "colocalization/EN-7_EN-17_section_15.pdf"), width = 15.75, height = 4.5)
plots
dev.off()
```


#### "EN-19", "EN-15", "EN-21", sc. 10, 12 (Supp. Fig. 11A)

```{r}
plots <- CellColoc3(ST,
                      features = c("EN-19", "EN-15", "EN-21"),
                      section_number = 10)

pdf(file = paste0(myfolder, "colocalization/EN-19_EN-15_EN-21_section_10.pdf"), width = 20, height = 6)
plots
dev.off()
```
...
pdf(file = paste0(myfolder, "colocalization/EN-19_EN-15_EN-21_section_12.pdf"), width = 20, height = 6)
plots
dev.off()
```


#### "EN-13", "EN-10", "EN-2", sc. 10, 12 (Supp. Fig. 11A)

```{r}
plots <- CellColoc3(ST,
                      features = c("EN-13", "EN-10", "EN-2"),
                      section_number = 10)

pdf(file = paste0(myfolder, "colocalization/EN-13_EN-10_EN-2_section_10.pdf"), width = 20, height = 6)
plots
dev.off()
```
...
pdf(file = paste0(myfolder, "colocalization/EN-13_EN-10_EN-2_section_12.pdf"), width = 20, height = 6)
plots
dev.off()
```


#### "FB-4", "FB-13", "FB-11", sc. 7, 8 (Extended Fig. 6G)
...
pdf(file = paste0(myfolder, "colocalization/FB-4_FB-11_FB-13_section_7.pdf"), width = 20, height = 6)
plots
dev.off()
```
...
pdf(file = paste0(myfolder, "colocalization/FB-4_FB-11_FB-13_section_8.pdf"), width = 20, height = 6)
plots
dev.off()
```


#### "CM-6", "CM-1", "CM-8-2", sc. 7 (Extended Fig. 7E)

```{r}
plots <- CellColoc3(ST,
                      features = c("CM-6", "CM-1", "CM-8-2"),
                      section_number = 7)

pdf(file = paste0(myfolder, "colocalization/CM-6_CM-1_CM-8-2_section_7.pdf"), width = 20, height = 6)
plots
dev.off()
```


#### "CM-9", "CM-14", "CM-19-1", sc. 7 (Extended Fig. 7E)

```{r}
plots <- CellColoc3(ST,
                      features = c("CM-9", "CM-14", "CM-19-1"),
                      section_number = 7)

pdf(file = paste0(myfolder, "colocalization/CM-9_CM-14_CM-19-1_section_7.pdf"), width = 20, height = 6)
plots
dev.off()
```


#### "FB-7", "FB-8", "FB-14", sc. 7, sc. 20 (Fig. 6E)
...
pdf(file = paste0(myfolder, "colocalization/FB-7_FB-8_FB-14_section_7.pdf"), width = 20, height = 6)
plots
dev.off()
```
...
pdf(file = paste0(myfolder, "colocalization/FB-7_FB-8_FB-14_section_20.pdf"), width = 20, height = 6)
plots
dev.off()
```


#### "FB-7", "FB-8", sc. 7 (Extended Fig. 6G)

```{r}
plots <- CellColoc(ST,
                      features = c("FB-7", "FB-8"),
                      section_number = 7)

pdf(file = paste0(myfolder, "colocalization/FB-7_FB-8_section_7.pdf"), width = 15.75, height = 4.5)
plots
dev.off()
```


#### "EN-2", "EN-10", sc. 5, 2, 11, 24 (Supp. Fig. 11B)
...
pdf(file = paste0(myfolder, "colocalization/EN-2_EN-10_section_5.pdf"), width = 15.75, height = 4.5)
plots
dev.off()
```
...
pdf(file = paste0(myfolder, "colocalization/EN-2_EN-10_section_2.pdf"), width = 15.75, height = 4.5)
plots
dev.off()
```
...
pdf(file = paste0(myfolder, "colocalization/EN-2_EN-10_section_11.pdf"), width = 15.75, height = 4.5)
plots
dev.off()
```
...
pdf(file = paste0(myfolder, "colocalization/EN-2_EN-10_section_24.pdf"), width = 15.75, height = 4.5)
plots
dev.off()
```


#### "EN-1", "EN-12", sc. 5, 2, 11, 24 (Supp. Fig. 11C)
...
pdf(file = paste0(myfolder, "colocalization/EN-1_EN-12_section_5.pdf"), width = 15.75, height = 4.5)
plots
dev.off()
```
...
pdf(file = paste0(myfolder, "colocalization/EN-1_EN-12_section_2.pdf"), width = 15.75, height = 4.5)
plots
dev.off()
```
...
pdf(file = paste0(myfolder, "colocalization/EN-1_EN-12_section_11.pdf"), width = 15.75, height = 4.5)
plots
dev.off()
```
...
pdf(file = paste0(myfolder, "colocalization/EN-1_EN-12_section_24.pdf"), width = 15.75, height = 4.5)
plots
dev.off()
```


#### "EN-3", "EN-6", sc. 5, 2, 11, 24 (Supp. Fig. 11C)
...
pdf(file = paste0(myfolder, "colocalization/EN-3_EN-6_section_5.pdf"), width = 15.75, height = 4.5)
plots
dev.off()
```
...
pdf(file = paste0(myfolder, "colocalization/EN-3_EN-6_section_2.pdf"), width = 15.75, height = 4.5)
plots
dev.off()
```
...
pdf(file = paste0(myfolder, "colocalization/EN-3_EN-6_section_11.pdf"), width = 15.75, height = 4.5)
plots
dev.off()
```
...
pdf(file = paste0(myfolder, "colocalization/EN-3_EN-6_section_24.pdf"), width = 15.75, height = 4.5)
plots
dev.off()
```
