...
#### Heatmap of niches (Fig. 7B, 7C, Supp Fig. 7C)

```{r}
niches <- list(c("CM-18", "CM-4-2", "CM-4-1", "EN-1", "EN-12"),
               c("EN-15", "HL-10", "FB-6"),
               c("EN-19", "EN-15", "EN-13", "EN-10", "EN-2"),
               c("EN-19", "HL-8", "FB-1"),
               c("EN-7", "EN-17", "FB-4"),
               c("EN-1", "EN-12", "CM-4-2"),
               c("HL-10", "FB-6", "EN-15"),
               c("FB-1", "FB-6", "HL-8", "EN-19"),
               c("FB-1", "HL-15", "EN-20"),
               c("CM-19-2", "CM-19-1", "FB-17", "EN-18", "EN-16"),
               c("CM-19-1", "CM-19-2", "FB-17"),
               c("EN-17", "EN-7", "FB-4", "FB-13", "FB-11", "CM-8-2"),
               c("HL-15", "EN-20", "FB-1", "FB-6", "HL-8", "EN-19", "HL-10", "EN-15"))
...
####  "IN-13", "CM-14", "IN-1"  in sc. 22 (Supp Fig. 4D)
...
#### "IN-13",  "FB-1",  "IN-1"   in sc. 32 and 34 (Supp Fig. 4D)
...
#### "FB-1", "HL-8", "EN-19", sc.9, 12, 20 (Supp Fig. 7C)
...
#### "EN-7", "EN-17", "FB-4", sc. 2, 20 (Fig. 7C)
...
#### "CM-19-2", "CM-19-1", "FB-17", sc. 19, 25 (Fig. 7B)
...
#### "CM-4-2", "EN-1", "EN-12" - 4 different sections

```{r}
# time point 1
plots1 <- CellColoc3(ST,
                      features = c("CM-4-2", "EN-1", "EN-12"),
                      section_number = 5)
...
pdf(file = paste0(myfolder, "colocalization/CM-4-2_EN-1_EN-12.pdf"), width = 15.75, height = 4.5)
p
dev.off()
```
...
pdf(file = paste0(myfolder, "colocalization/CM-4-2_EN-1_EN-12_section_5.pdf"), width = 20, height = 6)
plots
dev.off()
```
...
pdf(file = paste0(myfolder, "colocalization/CM-4-2_EN-1_EN-12_section_2.pdf"), width = 20, height = 6)
plots
dev.off()
```
...
pdf(file = paste0(myfolder, "colocalization/CM-4-2_EN-1_EN-12_section_11.pdf"), width = 20, height = 6)
plots
dev.off()
```
...
pdf(file = paste0(myfolder, "colocalization/CM-4-2_EN-1_EN-12_section_24.pdf"), width = 20, height = 6)
plots
dev.off()
```
...
pdf(file = paste0(myfolder, "colocalization/EN-2_EN-10.pdf"), width = 15.75, height = 4.5)
p
dev.off()
```
...
pdf(file = paste0(myfolder, "colocalization/FB-1_HL-8_EN-19_section_11.pdf"), width = 20, height = 6)
plots
dev.off()
```


#### "FB-1", "HL-8", "EN-19", sc. 13
...
pdf(file = paste0(myfolder, "colocalization/FB-1_HL-8_EN-19_section_13.pdf"), width = 20, height = 6)
plots
dev.off()
```


#### "FB-6", "HL-10", "EN-15", sc. 11
...
pdf(file = paste0(myfolder, "colocalization/FB-6_HL-10_EN-15_section_11.pdf"), width = 20, height = 6)
plots
dev.off()
```


#### "FB-6", "HL-10", "EN-15", sc. 13
...
pdf(file = paste0(myfolder, "colocalization/FB-6_HL-10_EN-15_section_13.pdf"), width = 20, height = 6)
plots
dev.off()
```


#### "EN-19", "EN-15", "EN-13", sc. 11

```{r}
plots <- CellColoc3(ST,
                      features = c("EN-19", "EN-15", "EN-13"),
                      section_number = 11)

pdf(file = paste0(myfolder, "colocalization/EN-19_EN-15_EN-13_section_11.pdf"), width = 20, height = 6)
plots
dev.off()
```


#### "CM-4-2", "EN-1", "EN-12", sc. 19
...
pdf(file = paste0(myfolder, "colocalization/CM-4-2_EN-1_EN-12_section_19.pdf"), width = 20, height = 6)
plots
dev.off()
```
...
#### "FB-11", "FB-13", "CM-8-2", sc. 20 (Fig. 7C)
...
#### "EN-16", "EN-18", "CM-19-1", in sc. 19 (Fig. 7B)
...
pdf(file = paste0(myfolder, "colocalization/EN-16_EN-18_CM-19-1_section_19.pdf"), width = 20, height = 6)
plots
dev.off()
```
