---
title: "10_HDCA_heart_extra_analysis"
...
### DGE normal - selection of HL clusters (HL_8, HL_10, HL_22) (Supp. Fig. 3C)
...
### FeaturePlots - special in HL_15 clusters (Supp Fig. 4C)
...
### FeaturePlots - special in HL_29 clusters (Supp Fig. 4C)
...
### Specific gene over all DL clusters (Supp. Fig. 9C)

```{r}
# specific list of marker to project the dotplot on
my_markers <- c("SHOX2", "TBX18", "PRRX1", "ZNF385B", "TENM4", "TENM3", "TENM2", "GDF10", "SLIT2", "RCAN1", "IRX1", "IRX2", "IRX5", "IRX3", "BRINP3", "SEMA3A", "PLXNA4")
...
pdf(paste0(myfolder, "DL_dotplot_marker_genes_v3.pdf"), width = 20, height = 4.5)
  print(p)
dev.off()
```


### Specific gene over all DL clusters (Supp. Fig. 5E)

```{r}
# specific list of marker to project the dotplot on
my_markers <- c("WT1", "TBX18", "TCF21")

# reorder the cell types desired
data_kept_cells$annot_dl <- factor(data_kept_cells$annot_dl, 
                                   levels = c("CM_19-2", "CM_19-1", "CM_12", "CM_9", "CM_14", "CM_4-2", "CM_4-1", "CM_18", "CM_8-2", "CM_8-1", "CM_8-3", "CM_17", "CM_6", "CM_1",  "CM_10", "CM_3", "CM_7", "CM_2", "CM_5",  
                                             "EN_1", "EN_12",  "EN_3", "EN_6", "EN_18", "EN_17", "EN_7", "EN_19", "EN_15",  "EN_13", "EN_10", "EN_2", "EN_5",  "EN_21", "EN_16",  "EN_20", "EN_11", "EN_14",  
                                             "FB_7", "FB_3", "FB_18","FB_14", "FB_5", "FB_9", "FB_19", "FB_12", "FB_2", "FB_4", "FB_13", "FB_11", "FB_17", "FB_8", "FB_1", "FB_6", "FB_15",  "FB_20",
"IN_4", "IN_7", "IN_12", "IN_11", "IN_8", "IN_19", "IN_17", "IN_3", "IN_13", "IN_1",
                                             "HL_8", "HL_10", "HL_22", "HL_20", "HL_15", "HL_29", "HL_18_1", "HL_6", "HL_34"
                                              ))
...
pdf(paste0(myfolder, "DL_dotplot_marker_genes_v3.2.pdf"), width = 20, height = 4.5)
  print(p)
dev.off()
```


### Specific gene over FB + HL_22 + HL_10 + HL_8 (Supp. Fig. 3F)
...
### Specific gene over FB + HL_20 (Supp. Fig. 5B)
...
### Specific gene over CM (Extended Fig. 4E)
...
### Specific gene over IN (Extended Fig. 4F)
...
### Specific gene over FB + HL_20 (Supp. Fig. 5C)
...
### DEG HL_20, FB_7, FB_3 (Supp. Fig. 4C)
...
### Merge data frames IN_1+IN_13 (L) --> SAN (R) // CHAT-CHRM2 and TH-ADRB1 (Extended Fig. 4D)
...
### Plot Heatmap IN_13 to SAN_CM & SAN_CM to IN_13 (Extended Fig. 4G)
...
#### CM from High Level dotplot from selected markers (Supp Fig. 2A)
...
pdf(paste0(myfolder, "cardiomyocytes/dotplot_markers_CM_spe_markers.pdf"), width = 7, height = 6)
par(mfrow=c(1,1), mar=c(3,6,2,5))
