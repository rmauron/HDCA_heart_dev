...
```{r}
annotation <- read.csv2("/home/rstudio/project/data/metadata/HDCA_heart_SC annotations_FB_240115.csv", header = 1, sep = ";")
...
### DEG FB selection of markers (Extended Fig. 3D)
...
### DEG FB subtype selection of markers
...
data_FB$cell.types <- factor(data_FB$cell.types, levels = c("EPDC_1", 
                                                            "EPDC_2", 
                                                            "Infl_FB", 
                                                            "FAP", 
                                                            "Int_FB_1", 
...
data_FB <- SetIdent(data_FB, value = "cell.types")
...
#### Table HL vs DL cells

```{r}
cell_HL_DL <- table(FB$cell.types, FB$clusters_subset)

# Save markers_table
write.csv(cell_HL_DL, file = paste0(myfolder, "fibroblast/", "cell_HL_DL", "_FB", ".tsv"))
```
