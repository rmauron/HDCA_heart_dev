...
```{r}
annotation <- read.csv2("/home/rstudio/project/data/metadata/HDCA_heart_SC annotations_CM_240115.csv", header = 1, sep = ";")
...
data_CM$cell.types <- factor(data_CM$cell.types, 
                                              levels = c("vCM_1", "AVB-BB_CM", "AVN_CM"))
...
feature_list <- c("LRRC4C", "UNC80", "DLGAP1", "SHOX2", "TBX18", "BMP2", "RSPO3", "ADAMTS19", "RCAN1", "HS3ST3A1", "CNTN5", "CRNDE", "BHLHE41", "RORA", "KCNJ2", "KCNJ3", "KCND2", "KCND3", "NRXN3", "ZNF536", "KCNK13", "CACNA1E", "CACNA1B", "KCNJ5", "KCNIP4")

for (feature in feature_list){
  p <-   FeaturePlot(data_CM, reduction = "umap_subset", features = feature, raster = FALSE, order = FALSE)

  pdf(paste0(myfolder, "cardiomyocytes/feature_plots/", feature, ".pdf"), width = 10, height = 10)
  print(p)
  dev.off()
}
```
...
# reorder the cell types desired
DGE_DATA$cell.types <- factor(DGE_DATA$cell.types, levels = c("PF_CM", "TsPF_CM"))
...
pdf(paste0(myfolder, "cardiomyocytes/DEG_top10_CM_4_2_4_1.pdf"), width = 5, height = 7)
par(mfrow=c(1,1), mar=c(3,6,2,5))
