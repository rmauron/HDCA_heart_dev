...
#### Enrichment of unique TF in remaining clusters (Extended Tab. 5)
...
# Save markers_table
write.csv(markers_table, paste0(myfolder, "supplementary_tables/extended_table_5_TF_DEG_EN_18.csv"))
...
### Regulons (Extended Tab. 4)

```{r}
regulon_table <- regulonTargetsInfo[,1:4]

# Save the detable as a csv file.
write.csv2(regulon_table, paste0(myfolder, "supplementary_tables/extended_table_4_regulon_EN_18.csv"))
```
...
#### Enrichment of multiple TF (Fig. 5F)
...
### Plot Gene Regulatory Networks (Fig. 5E)
