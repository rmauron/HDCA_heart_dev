---
title: "07_3_HDCA_heart_SCENIC_FB_14"
...
# write.csv(list_unique_TF, file = paste0(myfolder, "scenic/markers_table/", "list_unique_TF","_FB_", cluster, ".tsv"))
```


#### Enrichment of unique TF in remaining clusters (Extended Tab. 9)
...
# Save markers_table
write.csv(markers_table, paste0(myfolder, "supplementary_tables/extended_table_9_TF_DEG_FB.csv"))
```
...
### Regulons (Extended Tab. 8)

```{r}
regulon_table <- regulonTargetsInfo[,1:4]

# Save the detable as a csv file.
write.csv2(regulon_table, paste0(myfolder, "supplementary_tables/extended_table_8_regulon_FB_14.csv"))
```
...
### Plot Gene Regulatory Networks (Supp Fig. 6D)
