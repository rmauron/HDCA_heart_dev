...
# HDCA heart SCENIC CM19-2, CM19-1, CM4-2, EN7, EN17, EN18, FB14, FB4 ???
...
Ran independently for CM19-2, CM19-1, CM4-2, EN7, EN17, EN18, FB14, FB4

```{r}
# CHANGE HERE
data_cell <- EN
cluster <- "17"
data_sub <- data_cell[,data_cell$clusters_subset %in% cluster] #clusters_subset_split for CM
```
