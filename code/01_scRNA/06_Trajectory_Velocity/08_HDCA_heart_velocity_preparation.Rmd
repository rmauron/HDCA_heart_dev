---
title: "08_HDCA_heart_velocity_preparation"
...
In order to perform RNA velocity using scVelo, several files needed to be generated. 
*Spliced count* and *Unspliced count* from the **.h5** files directly. Those Seurat objects need to be converted in **.h5ad** format in order to be used as AnnData object in Python (10_HDCA_heart_velocity_preparation.Rmd in the conda environment). We also export metadata in **.tsv** and umap embedding in **.csv** from the high level data, and the four deep level objects (CM, EN, FB, IN).
...
```{r}
fwrite(data@meta.data, paste0("/home/rstudio/project/data/AnnData/metadata.tsv"), sep='\t', col.names = T, row.names = T, quote=F)

fwrite(CM@meta.data, paste0("/home/rstudio/project/data/AnnData/metadata_CM.tsv"), sep='\t', col.names = T, row.names = T, quote=F)

fwrite(EN@meta.data, paste0("/home/rstudio/project/data/AnnData/metadata_EN.tsv"), sep='\t', col.names = T, row.names = T, quote=F)

fwrite(FB@meta.data, paste0("/home/rstudio/project/data/AnnData/metadata_FB.tsv"), sep='\t', col.names = T, row.names = T, quote=F)

fwrite(IN@meta.data, paste0("/home/rstudio/project/data/AnnData/metadata_IN.tsv"), sep='\t', col.names = T, row.names = T, quote=F)

fwrite(IN_subset@meta.data, paste0("/home/rstudio/project/data/AnnData/metadata_IN_selection.tsv"), sep='\t', col.names = T, row.names = T, quote=F)
```
...
```{r}
write.csv(data@reductions$umap_oi@cell.embeddings, file = paste("/home/rstudio/project/data/AnnData/UMAP.csv",sep=""))

write.csv(CM@reductions$umap_subset@cell.embeddings, file = paste("/home/rstudio/project/data/AnnData/UMAP_CM.csv",sep=""))

write.csv(EN@reductions$umap_subset@cell.embeddings, file = paste("/home/rstudio/project/data/AnnData/UMAP_EN.csv",sep=""))

write.csv(FB@reductions$umap_subset@cell.embeddings, file = paste("/home/rstudio/project/data/AnnData/UMAP_FB.csv",sep=""))

write.csv(IN@reductions$umap_subset@cell.embeddings, file = paste("/home/rstudio/project/data/AnnData/UMAP_IN.csv",sep=""))

write.csv(IN_subset@reductions$umap_subset_sub@cell.embeddings, file = paste("/home/rstudio/project/data/AnnData/UMAP_IN_selection.csv",sep=""))
```
