---
title: "03_4_HDCA_heart_load_bnaksy regions"
...
### Dot plot selected markers on Banksy regions
...
### Seurat cluster vs Banksy regions
...
#table(DGE_DATA$banksy_09, ST_clustering$seurat_clusters)
```
...
### Add banksy region to ST_clustering object and embed umap
