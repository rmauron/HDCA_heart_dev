...
### Banksy sc. 2, 5, 11 and 24 (Supp Fig. 1A)
...
### Dot plot selected markers on Banksy regions (Supp. Fig. 1E)
...
### Seurat cluster vs Banksy regions (Supp. Fib. 1D)
...
### Add banksy region to ST_clustering object and embed umap (Supp Fig. 1B)
